...
mixin _$ProductResponse {
  List<ProductModel> get productResponse => throw _privateConstructorUsedError;
...
abstract class $ProductResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ProductModel> productResponse});
}
...
class _$ProductResponseCopyWithImpl<$Res, $Val extends ProductResponse>
  ...
  @override
  $Res call({Object? productResponse = null}) {
    return _then(
      _value.copyWith(
            productResponse:
...
class _$ProductResponseImpl implements _ProductResponse {
  const _$ProductResponseImpl({
    required final List<ProductModel> productResponse,
  ...
  final List<ProductModel> _productResponse;
  @override
  List<ProductModel> get productResponse {
  ...
  @override
  String toString() {
    return 'ProductResponse(productResponse: $productResponse)';
  }
  ...
  int get hashCode => Object.hash(
    runtimeType,
    const DeepCollectionEquality().hash(_productResponse),
  );
